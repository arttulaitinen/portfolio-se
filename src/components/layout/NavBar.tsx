          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-0 w-48 bg-gray-800 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                ...
                <Link to="/internship-reflection" className="block px-4 py-2 text-white hover:bg-gray-700">
                  Internship Reflection
                </Link>
                <Link to="/ci-cd-pipeline" className="block px-4 py-2 text-white hover:bg-gray-700">
                  CI/CD Pipeline
                </Link>
                <Link to="/design-doc" className="block px-4 py-2 text-white hover:bg-gray-700">
                  Design Document
                </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-2">
            ...
            <div className="px-3 py-2">
              <p className="text-white font-medium mb-2">Projektit ja kurssit</p>
